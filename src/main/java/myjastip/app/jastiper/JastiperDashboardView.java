...
public class JastiperDashboardView {

    private final MyJastipWindow appWindow;
    private Scene dashboardScene;
    private Jastiper jastiper;
    private BorderPane mainLayout;
    private JastiperOrderLayout jastiperOrderLayout;

    public JastiperDashboardView(MyJastipWindow appWindow) {
...
//                orderBox.getChildren().remove(orderMenu);
    ...
    public VBox createJastiperDashboard() {
...
//        String username = (customer != null) ? customer.getName() : "null";
        Label welcomeLabel = new Label("Selamat Datang, " + jastiper.getName() + "!");
        ...
        Label balanceLabel = new Label("Rp. " + new BigDecimal(String.valueOf(DatabaseUtil.getUser(jastiper.getUserId()).getBalance())).toPlainString());
        ...
        layout.getChildren().addAll(userBox, saldoCard, orderScrollPane);
    ...
    public void createDashboardScene() {
        ...
        showView(createJastiperDashboard());
...
//        // Attach specialized view-swapping actions to button click contexts
        ...
        btnOrders.setOnAction(e -> {
            jastiperOrderLayout = new JastiperOrderLayout(jastiper);
            showView(jastiperOrderLayout.createJastiperOrderLayout());
            sidebar.getChildren().forEach(node -> node.setStyle(defaultNavStyle));
            btnOrders.setStyle(activeNavStyle);
        });


        sidebar.getChildren().addAll(btnDashboard, btnOrders);
        return sidebar;
    }
